package me.primooctopus33.octohack.client;
...
implements Util {
    ...
    public TextManager renderer = OctoHack.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof OctoHackGui) {
            OctoHackGui.getInstance().updateModule((Module)this);
        }
        return setting;
    }
