    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : OctoHack.moduleManager.getCategories()) {
                ...
                for (Module module1 : OctoHack.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = OctoHack.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = OctoHack.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
