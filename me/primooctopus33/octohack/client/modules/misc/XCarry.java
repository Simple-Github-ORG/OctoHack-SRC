...
import me.primooctopus33.octohack.util.ReflectionUtil;
...
extends Module {
    ...
    public XCarry() {
        super("XCarry", "Uses the crafting inventory for storage", Module.Category.MISC, true, false, false);
        this.setInstance();
    }
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (Keyboard.getEventKeyState() && !(XCarry.mc.currentScreen instanceof OctoHackGui) && this.autoStore.getValue().getKey() == Keyboard.getEventKey()) {
            this.autoDuelOn = !this.autoDuelOn;
            Command.sendMessage("<XCarry> \u00a7aAutostoring...");
        }
    }
