...
import me.primooctopus33.octohack.client.gui.font.CustomFont;
...
extends Feature {
    ...
    public void init(boolean startup) {
        FontMod cFont = OctoHack.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public void drawString(String text, float x, float y, int color, boolean shadow) {
        if (OctoHack.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {
