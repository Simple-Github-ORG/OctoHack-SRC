...
implements Util {
    ...
    public static void faceVector(Vec3d vec, boolean normalizeAngle) {
        ...
        BurrowUtil.mc.player.connection.sendPacket(new CPacketPlayer.Rotation(rotations[0], normalizeAngle ? (float)MathHelper.normalizeAngle((int)((int)rotations[1]), (int)360) : rotations[1], BurrowUtil.mc.player.onGround));
    }
