...
implements Util {
    ...
    public static float[] calculateLookAt(double x, double y, double z, EntityPlayer me) {
        double dirx = MathUtil.lerp((double)mc.getRenderPartialTicks(), me.lastTickPosX, me.posX) - x;
        double diry = MathUtil.lerp((double)mc.getRenderPartialTicks(), me.lastTickPosY, me.posY) + (double)me.getEyeHeight() - y;
        double dirz = MathUtil.lerp((double)mc.getRenderPartialTicks(), me.lastTickPosZ, me.posZ) - z;
        ...
        pitch = (float)((double)(pitch * 180.0f) / Math.PI);
        yaw = (float)((double)(yaw * 180.0f) / Math.PI);
