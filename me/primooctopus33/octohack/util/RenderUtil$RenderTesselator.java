...
public class RenderUtil$RenderTesselator
extends Tessellator {
    ...
    public static void prepare(int mode) {
        ...
        RenderUtil$RenderTesselator.begin(mode);
    }
    ...
    public static void release() {
        RenderUtil$RenderTesselator.render();
    ...
    public static void drawBox(BlockPos blockPos, int argb, int sides) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        RenderUtil$RenderTesselator.drawBox(blockPos, r, g, b, a, sides);
    }
    ...
    public static void drawBox(float x, float y, float z, int argb, int sides) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        RenderUtil$RenderTesselator.drawBox(INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static void drawBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
        RenderUtil$RenderTesselator.drawBox(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawFullBox(AxisAlignedBB bb, BlockPos blockPos, float width, int argb, int alpha2) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        RenderUtil$RenderTesselator.drawFullBox(bb, blockPos, width, r, g, b, a, alpha2);
    }
    ...
    public static void drawFullBox(AxisAlignedBB bb, BlockPos blockPos, float width, int red, int green, int blue, int alpha, int alpha2) {
        RenderUtil$RenderTesselator.prepare(7);
        RenderUtil$RenderTesselator.drawBox(blockPos, red, green, blue, alpha, 63);
        RenderUtil$RenderTesselator.release();
        RenderUtil$RenderTesselator.drawBoundingBox(bb, width, red, green, blue, alpha2);
    }
    ...
    public static void drawHalfBox(BlockPos blockPos, int argb, int sides) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        RenderUtil$RenderTesselator.drawHalfBox(blockPos, r, g, b, a, sides);
    }

    public static void drawHalfBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
        RenderUtil$RenderTesselator.drawBox(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 0.5f, 1.0f, r, g, b, a, sides);
    }
}
