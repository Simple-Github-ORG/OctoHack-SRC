...
public class TestUtil {
    ...
    public static Vec3d getInterpolatedRenderPos(Entity entity, float partialTicks) {
        return TestUtil.getInterpolatedPos(entity, partialTicks).subtract(EntityUtil.mc.getRenderManager().renderPosX, EntityUtil.mc.getRenderManager().renderPosY, EntityUtil.mc.getRenderManager().renderPosZ);
    }
    ...
    public static boolean canPlaceBlock(BlockPos pos) {
        if (TestUtil.isBlockEmpty(pos)) {
            ...
            for (EnumFacing f : facings = EnumFacing.values()) {
                ...
                Vec3d vec3d = new Vec3d((double)pos.getX() + 0.5 + (double)f.getFrontOffsetX() * 0.5, (double)pos.getY() + 0.5 + (double)f.getFrontOffsetY() * 0.5, (double)pos.getZ() + 0.5 + (double)f.getFrontOffsetZ() * 0.5);
