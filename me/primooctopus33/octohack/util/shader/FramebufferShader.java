...
import me.primooctopus33.octohack.mixin.mixins.accessors.IEntityRenderer;
import me.primooctopus33.octohack.util.shader.Shader;
...
extends Shader {
    ...
    public void startDraw(float partialTicks) {
        ...
        ((IEntityRenderer)((Object)this.mc.entityRenderer)).setupCameraTransformInvoker(partialTicks, 0);
    }
